    ...
    <>
      <div className="text-gray-600 body-font w-[80%] mx-auto mt-[100px]">
        <div className="px-[10px]">
          <h2 className="title-font sm:text-4xl text-3xl mb-4font-medium text-gray-900 mt-8">
            Driving the force of <span className="text-yellow-500">Assortment</span>
          </h2>
          <p className="mb-8 mt-2 leading-relaxed text-[20px]">
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 mdpr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
